...
describe('most likes', () => {
  test('find blog that has most likes', () => {
    const result = listHelper.favoriteBlog(listWithMoreBlog)
    expect(result).toEqual({
      title: listWithMoreBlog[2].title,
      author: listWithMoreBlog[2].author,
      likes: listWithMoreBlog[2].likes
    })
  })
})

describe('most blogs', () => {
  test('find author that has most blogs', () => {
    const result = listHelper.mostBlog(listWithMoreBlog)
    expect(result).toEqual({
      author: 'Robert C. Martin',
      blogs: 3
    })
...
describe('most likes', () => {
  test('find author that has most likes', () => {
